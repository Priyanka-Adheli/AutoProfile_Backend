...
//controller for enhancing a reusme professional summary
//post - /ai/enhance-pro-sum
...
export const enhanceProfessionalSummary = async(req,res)=>{
    ...
    return res.status(201).json({enhanceContent})
    }
    catch(error)
    {
...
//controller to enhance the job description
